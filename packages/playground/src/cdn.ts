...
importMap.set("@fullcalendar/core/locales/cs", ["/web_modules/@fullcalendar/core/locales/cs.js"])
importMap.set("@fullcalendar/core/locales/es", ["/web_modules/@fullcalendar/core/locales/es.js"])
importMap.set("@fullcalendar/core/locales/fr", ["/web_modules/@fullcalendar/core/locales/fr.js"])
importMap.set("@fullcalendar/core/locales/ru", ["/web_modules/@fullcalendar/core/locales/ru.js"])
importMap.set("@fullcalendar/core/locales/sk", ["/web_modules/@fullcalendar/core/locales/sk.js"])
importMap.set("@fullcalendar/core/main.css", ["/web_modules/@fullcalendar/core/main.css"])
importMap.set("@fullcalendar/daygrid", ["/web_modules/@fullcalendar/daygrid.js"])
importMap.set("@fullcalendar/daygrid/main.css", ["/web_modules/@fullcalendar/daygrid/main.css"])
importMap.set("@fullcalendar/interaction", ["/web_modules/@fullcalendar/interaction.js"])
importMap.set("@fullcalendar/timegrid", ["/web_modules/@fullcalendar/timegrid.js"])
importMap.set("@fullcalendar/timegrid/main.css", ["/web_modules/@fullcalendar/timegrid/main.css"])
importMap.set("@material/mwc-button", ["/web_modules/@material/mwc-button.js"])
importMap.set("@material/mwc-checkbox", ["/web_modules/@material/mwc-checkbox.js"])
...
importMap.set("@material/mwc-icon-button", ["/web_modules/@material/mwc-icon-button.js"])
importMap.set("@material/mwc-linear-progress", ["/web_modules/@material/mwc-linear-progress.js"])
importMap.set("@material/mwc-list", ["/web_modules/@material/mwc-list.js"])
importMap.set("@material/mwc-list/mwc-check-list-item", ["/web_modules/@material/mwc-list/mwc-check-list-item.js"])
importMap.set("@material/mwc-list/mwc-list", ["/web_modules/@material/mwc-list/mwc-list.js"])
importMap.set("@material/mwc-list/mwc-list-item", ["/web_modules/@material/mwc-list/mwc-list-item.js"])
...
importMap.set("@material/mwc-snackbar", ["/web_modules/@material/mwc-snackbar.js"])
importMap.set("@material/mwc-tab", ["/web_modules/@material/mwc-tab.js"])
importMap.set("@material/mwc-tab-bar", ["/web_modules/@material/mwc-tab-bar.js"])
importMap.set("@material/mwc-textarea", ["/web_modules/@material/mwc-textarea.js"])
importMap.set("@material/mwc-textfield", ["/web_modules/@material/mwc-textfield.js"])
importMap.set("@material/mwc-top-app-bar", ["/web_modules/@material/mwc-top-app-bar.js"])
...
export async function cdnImports(source: string, path: string) {
  const cacheDeps = await caches.open('dependencies');
  ...
  for (let match of importMatches || []) {
    ...
    if (dependency.endsWith('.css')) {
      ...
      imports = [...imports, CONTROLLED + 'import.css']
      continue;
    }
