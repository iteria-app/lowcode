...
export function createAst(code: string, scriptTarget = ScriptTarget.ESNext, scriptKind = ScriptKind.TSX, filePath = `/ts-ast-viewer.tsx`) {
    ...
    function getBindingResult() {
        ...
        const files: { [name: string]: SourceFile | undefined } = { [filePath]: sourceFile };
