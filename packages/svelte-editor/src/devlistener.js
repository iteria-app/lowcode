...
//var newStackFrame = new StackFrame({ fileName: "http://localhost:5000/build/bundle.js", lineNumber: 18575, columnNumber: 8 })
//var stackFrameObject = { fileName: "http://localhost:5000/build/bundle.js", lineNumber: 18575, columnNumber: 8 }
...
export function newDevListener() {
  ...
  function stack(dbg) {
    ...
    StackTrace.get().then((x) => {
      //mconsole.log('fuck', x)
      //gps.pinpoint(x[0]).then((o) => console.log('Pinpoint with custom stackframe', o));
      gps.getMappedLocation(x[0]).then((or) => { console.log('Mapped Location', or) });
    }
